...
class IngestionReader extends LogReader {
    constructor(params) {
        ...
        this._iProducer = new IngestionProducer(bucketdConfig, qpConfig,
            s3Config);
        this.bucketdName = bucketdConfig.zenkoBucketName;
        // TODO-FIX: no longer have prefix in config.
        this.bucketdPrefix = bucketdConfig.prefix ? bucketdConfig.prefix :
            bucketdConfig.zenkoBucketName;
        this.newIngestion = false;
        this.remoteLogOffset = null;
        if (ingestionPath) {
            // TODO: hard-coded "ingestion" -> zookeeperSuffix
            this.pathToLogOffset = `${ingestionPath}/ingestion` +
    ...
    _processLogEntry(batchState, record, entry, bucketdPrefix) {
        ...
        // TODO-FIX: no longer have prefix in configs
